...
git_repo_url = "https://github.com/kaidman/nimble-custom.git"
...
def execute(task_args):
    ...
    training_args = TrainingArguments(
        output_dir="my_model", evaluation_strategy="epoch", save_strategy='epoch', seed=task_args['seed'], full_determinism=True, torch_compile=True
    )
...
def complete_task(wallet_address,training_duration=0, max_retries=100, retry_delay=30):
    retries = 0
